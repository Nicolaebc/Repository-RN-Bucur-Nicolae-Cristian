...
def load_data():
    try:
        ...
        print("Asigura-te că ai rulat generatorul")
        sys.exit(1)
...
experiments = [
    ...
    {
        "name": "Exp 3: Arhitectura Complexa",
        "layers": [64, 32, 16],
        "lr": 0.001,
        "dropout": 0.0,
        "batch_size": 32
...
if best_model is None:
    print("Nu s-a antrenat niciun model corect")
    sys.exit(1)
